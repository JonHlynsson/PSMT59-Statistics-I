...
grViz("digraph flowchart {
      ...
      [1]: 'Study sample n=63'
      [2]: 'Participants compleated the dual n-back task (DNB) and back-ward digit span task (BDS)'
      [3]: 'Participants heard natural sounds n=31'
      [4]: 'Participants heard urban sounds n=32'
      [5]: 'Participants retook the dual n-back task (DNB) and back-ward digit span task (BDS)'
      [6]: 'Participants gave information on whether they guessed the purpose of the experiment'
      [7]: '17 participants guessed the purpose of the experiment'
      [8]: '46 participants did not guess the purpose of the experiment'
      ",
      width = 1000, 
      # height = 700
      )
