...
dstat %>% select(c("condition", "outcome", "sd_out")) %>%  kable(digits = 2,
...
<div align="center" style="font-family: Times;">Supplementary table 2. Descriptive statistics for the crude and adusted models</div>
<br> 
<div class="pull-left">
```{r, results='hold', out.width="30%", include=T, echo=F}
...
d2statAdjusted %>% select(c("Type of soundscape", "Mean", "sd")) %>% 
  kable(digits = 2, caption = "Adjusted descriptives") %>% 
  kable_classic() %>% 
